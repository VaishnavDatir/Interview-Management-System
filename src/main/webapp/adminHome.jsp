...
List<Job> jobList = jobSer.getActiveJobs();
				...
				<div class="d-flex">
					<ul class="navbar-nav me-auto">
						<li class="nav-item"><a class="nav-link"
							href="./adminUser.jsp">Users</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./adminDepartment.jsp">Department</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./adminJobsPage.jsp">Jobs</a></li>
		...
		<div class="recent-jobs">
			...
			if (jobList.size() == 0) {
				...
				for (int i = 0; i < jobList.size(); i++) {
					...
					out.println("<div class='jLoction'>" + jobList.get(i).getjLocation() + "</div>");
					out.println("<div class='jLastDt'>Last date: <b>" + jobList.get(i).getjLastDT() + "</b></div>");
					out.println("</div>");
					out.println("</a>");
					out.println("</div>");
				}
